...
import { Dimensions, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, View, ActivityIndicator, Image, TouchableOpacity, Alert, Modal, Button } from "react-native";
        ...
        <SafeAreaView style={styles.container}>
            <View style={{ flexDirection: "row",marginBottom:18,alignItems:"center"}}>
                <View style={styles.inputContainer}>
                    ...
                    />
                    {inputFilter.length>0?<TouchableOpacity onPress={()=>(setInputFilter(""))}>
                        <Image source={{
                ...
                <View style={{flexDirection:"column",width:"34%",marginLeft:10,alignItems:"center"}}>
                    <Text style={{fontWeight:"500",fontSize:15}}>Filter by status</Text>
                    <Dropdown
                    ...
                    >
                        <View style={styles.modalOverlay}>
                            <View style={styles.modalContent}>
                                <Text style={styles.modalTitle}>Order Details #{viewOrderDetails[0]?.id}</Text>
                                ...
                                <ScrollView style={styles.scrollContent}>
                                    ...
                                    <Text style={[styles.sectionTitle, styles.sectionTitleUpdated]}>Order Items</Text>
                                    {viewOrderDetails[0]?.CartItems.map((cartItems: any, index: number) => (
                                        <View key={index} style={styles.orderItemRow}>
                                            <Text style={styles.orderItemName}>
                                                {cartItems.display_name} X {Number(cartItems.quantity)}
                                            </Text>
                                            <Text style={styles.orderItemPrice}>${cartItems.price}</Text>
                                        </View>
                                    ))}
                                    ...
                                    {viewOrderDetails[0]?.delivery_fee &&  <View style={styles.summaryRow}>
                                    ...
                                    <Text style={[styles.sectionTitle, styles.sectionTitleUpdated]}>Additional Details</Text>
                                    <View style={styles.infoRow}>
                                        <Text style={styles.label1}>Order Type:</Text>
                                        <Text style={styles.value}>  {viewOrderDetails[0]?.OrderTypeDefinition.Type}</Text>
                                    </View>
                                    <View style={styles.infoRow}>
                                        <Text style={styles.label1}>Schedule Date:</Text>
                                        <Text style={styles.value}>  {(new Date(viewOrderDetails[0]?.created_at * 1000)).toLocaleDateString()}
                                        </Text>
                                    </View>
                                    <View style={styles.infoRow}>
                                        <Text style={styles.label1}>Schedule Time:</Text>
                                        <Text style={styles.value}>  {formatTimeToAMorPM((new Date(viewOrderDetails[0]?.created_at * 1000)).toLocaleTimeString())}
                                        </Text>
                                    </View>
                                </ScrollView>
